...
var author$project$Main$GoingNowhere = {$: 'GoingNowhere'};
var author$project$Main$init = {count: 0, direction: author$project$Main$GoingNowhere};
var author$project$Main$GoingDown = {$: 'GoingDown'};
var author$project$Main$GoingUp = {$: 'GoingUp'};
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		var direction = function () {
			var _n2 = _Utils_cmp(value, model.count) > 0;
			if (_n2) {
				return author$project$Main$GoingUp;
			} else {
				return author$project$Main$GoingDown;
			}
		}();
		var _n1 = A2(elm$core$Debug$log, 'Change Count', model.count);
		return _Utils_update(
			model,
			{count: value, direction: direction});
	});
var author$project$Main$ChangeCount = function (a) {
		...
		switch (_n0.$) {
			case 'GoingUp':
				return A2(
					...
					_List_fromArray(
						[
							A2(elm$html$Html$Attributes$attribute, 'slot', 'direction-label')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('Going Up')
						]));
			case 'GoingDown':
				return A2(
					elm$html$Html$div,
			...
			default:
				return A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text('Going Nowhere')
						]));
		}
	}();
	return A2(
				...
				_List_fromArray(
					[
						...
						A2(
							...
							author$project$Main$ChangeCount,
							A2(
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"ChangeCount":["Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));